...
const HomePage = () => {
  return (
    <div>
      ...
      <footer className="container pt-16 pb-8 flex flex-col sm:flex-row gap-8 sm:gap-4 justify-around items-start">
        <Link href="/">
          <BrandLogo />
        </Link>
...
function Feature({
  ...
  return (
    <div className={cn("flex items-center gap-2", className)}>
      <CheckIcon className="size-4 stroke-accent bg-blue-500 rounded-full p-0.5" />
      <span>{children}</span>
    </div>
  )
}
