...
const Footer = () => {
  return (
    <footer
      className=" px-4 relative pt-24 lg:pt-[100px]"
      data-wow-delay=".15s"
    >
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="mb-8 max-w-[270px] text-base text-gray-7">
                Buni real estate is dedicated to revolutionizing Housing Stabilization Services (HSS) through innovative technology solutions.
              </p>
